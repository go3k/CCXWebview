...
bool HelloWorld::init()
{
    ...
    //Notice that webview is infront of current OpenGL view, so webview will cover all the contents in it's rect.
    ...
    m_webView->showWebView("http://www.baidu.com", 20, 20, 200, 200);
